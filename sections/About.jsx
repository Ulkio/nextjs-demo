  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    <motion.div
      ...
      <motion.p
        ...
        className="mt-[8px] font-normal sm:text-[32px] text-[20x] text-center text-secondary-white">
        <span className="font-extrabold text-white"> Metaverse </span>
        is a new thing in the future, where you can enjoy the virtual world by feeling like it's really real, you can
